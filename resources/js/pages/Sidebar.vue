        ...
        <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
            ...
            <router-link to="/admin/dashboard">
                <div class="app-sidebar-logo-default d-flex align-items-center">
                    <img alt="Logo" :src="app_store.client_logo"
                ...
                <img alt="Logo" :src="app_store.client_mini_logo"
                    ...
                    <div v-for="menu in sidebar.menu">
                        <div class="menu-item" v-if="!menu.children && menu.type !== 'title'">
                            ...
                            <router-link class="menu-link" :to="menu.url">
                                <span class="menu-icon"><CustomIcon :name="menu.icon"/></span>
